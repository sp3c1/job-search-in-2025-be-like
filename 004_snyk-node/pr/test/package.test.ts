...
// idea: use snapshot instead of providing mock manually
// idea: make a map of packages to use outside of actual test:
// easier to manage when you want to test same pkg twice but in different context
